 ...
 */
/**
 * A class for modeling Shield and offhand objects to be used by the player
 */
public class Shield extends ArmorBase implements Breakable, Repairable,
        Equippable, Upgradeable, Offhand, Defensive {

    /**
     * Creates a shield object using the ArmorBase class as a template
     */
    public Shield() {

        super("main.armor.Shield", "A simple wooden shield.", 25, 10);
    ...
    public void destroy() {
        ...
        this.setDescription("Remnants of a shield");
