 ...
 */
/**
 * A class for modeling leg armor objects to be used by the player
 */
public class LegGuard extends ArmorBase implements Breakable, Repairable,
        Equippable, Upgradeable, Legs, Defensive {

    /**
     * Creates a LegGuard object using the ArmorBase class as a template
     */
    public LegGuard() {

        super("Leather LegGuard", "A simple leather leg guard.", 25, 10);
    ...
    public void destroy() {
        ...
        this.setDescription("Remnants of leg guards");
